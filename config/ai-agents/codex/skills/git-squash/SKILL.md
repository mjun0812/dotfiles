---
name: git-squash
description: Squash and organize commits on the current branch with safe push guidance.
---
...
- PR title: !`gh pr view --json title --jq '.title'`
- PR body: !`gh pr view --json body --jq '.body' | head -30`
