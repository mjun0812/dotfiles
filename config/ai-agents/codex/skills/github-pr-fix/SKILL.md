---
name: github-pr-fix
description: Auto-detect and fix PR issues (conflicts, CI failures, review comments).
---
...
2. **Step 1: Check and fix conflicts**:
   ...
   - If `CONFLICTING`:
     - Execute `github-pr-fix-conflicts skill`
     - Wait for completion
...
4. **Step 3: Check and respond to review comments**:
   ...
   - If there are unaddressed comments:
     - Execute `github-pr-respond-comment skill (--reply 相当)`
     - Wait for completion
