---
name: github-fix-ci
description: Check CI status for a repository or PR, analyze failures, and fix issues.
---
...
- Suggest running `github-fix-ci skill` again after CI completes to verify
