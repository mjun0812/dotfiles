...
# Gemini-cli
alias gemini-commit='command gemini -i "/aicommit" --model=gemini-2.5-flash --allowed-tools "run_shell_command(git status),run_shell_command(git log:*),run_shell_command(git branch:*),run_shell_command(git diff:*),run_shell_command(git commit:*)"'
