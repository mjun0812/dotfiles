...
alias cc-aicommit='command claude --model=haiku /aicommit'
alias cc-aicommit-ja='command claude --model=haiku /aicommit_ja'
alias aicommit='cc-aicommit'
alias aicommit-ja='cc-aicommit-ja'
