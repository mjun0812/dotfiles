---
allowed-tools: Bash(cat:*),  Bash(git status:*), Bash(git add:*), Bash(git log:*), Bash(git branch:*), Bash(git diff:*), Bash(git commit:*), Bash(git push:*)
...
- Convetional Commitsの仕様: [Conventional Commits 1.0.0](#conventional-commits-100)
