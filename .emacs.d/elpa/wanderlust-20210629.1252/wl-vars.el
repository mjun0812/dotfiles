...
;; Important folders
(defcustom wl-default-folder "%configured note path"
...
(defvar wl-summary-redisplay-hook nil
  "A hook called when displaying message finishes.")
...
ex.
'((\"^%configured note path@qmail-maildir\" . 9)
  (\"^-.*@news-server\" . 6))"
...
(defcustom wl-auto-save-drafts-interval 300
