...
| Skill                                                                  | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`mjun-specify`](../config/ai-agents/skills/mjun-specify/SKILL.md)     | Polish an idea, GitHub issue, or local markdown into an implementable spec (contract): investigate facts, resolve agent-owned decisions autonomously, confirm human-owned or uncertain ones one at a time, auto-run task breakdown for multi-task specs, then project the approved contract with the task checklist to the issue (local-only specs are offered a projection-target issue at that point) Before asking for approval, a fresh-context reviewer subagent checks the contract for self-consistency, verifiable acceptance criteria, drift from the source, and the existence of cited evidence                                                                                                                                                  |
