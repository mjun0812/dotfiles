...
| [`mjun-design-review`](../config/ai-agents/skills/mjun-design-review/SKILL.md) | Adversarially review an implementation design (`design.md` under `.mjun/specs/<slug>`, any design markdown, or the design discussed in the conversation): a fresh-context reviewer checks contract coverage, boundaries, fit with the codebase, failure paths, test seams, and structural excess or gaps to produce candidates, then a verifier per candidate tries to refute it against real code and the contract text; only confirmed findings are returned to chat in severity order. Never edits files                                                                                                                                                                                                                                                 |
...
graph LR
    ...
    mjun-specify --> mjun-design-review
...
| `mjun-specify`   | `mjun-design-review`                                             | Phase 5.5 (before approval) reviews design.md; findings are applied under the same rules as the contract review |
