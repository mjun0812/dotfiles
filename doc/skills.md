...
| [`mjun-status`](../config/ai-agents/skills/mjun-status/SKILL.md)           | Derive and display the status of local specs (contract approval, task progress, implementation branch, projected issue) from `.mjun/specs/` and git without any index file; read-only                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| [`skill-review`](../config/ai-agents/skills/skill-review/SKILL.md)             | Validate Agent Skills compliance and report per-criterion verdicts, including trigger conflicts with nearby skills and leftovers of superseded criteria; edits nothing but its own criteria CHANGELOG |
