...
| [`mjun-status`](../config/ai-agents/skills/mjun-status/SKILL.md)           | `.mjun/specs/` とgitの内容からLocal specの状況 (contract承認、task進捗、blocked taskの原因・再開条件、実装branch、投影先Issue) を索引なしで導出して一覧・詳細表示する。読み取り専用                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
